/*
Vecchia strada non mi convince.
provo ad importare sia le librerie npm che vendor via link in index.html
dopo averle bundleate con Browserify

Questo vecchio approccio pensavo di importarle da qui ma non penso sia conveniente
perchè dovrei stare a definire tutti i require
mentre spero che importando via HTML lui mi esponga nel global namespace le oppurtune variabli
 */
// // LIBRERIE NPM
var jQuery = require('jquery');
var Modernizr = require('gulp-modernizr');
var L = require('leaflet');
var $ = require('leaflet-editinosm');

// // TUTTE LE LIBRERIE VENDOR, CIOè QUELLE CHE NON RIESCO AD INSTALLARE CON NPM, BUNDLEATE
// // non sono sicurissimo di doverle imporate qui come bundle o se mi basta linkarle dall'HTML
// var bundle = 
...
Nuova Strada:
provo a fare un primo bunlde di npm+vendor
lo importo qui
richiedo i dati via reuquire
faccio un secondo bundle
immport l'ultimo bundle in html
 */

// PRIMO BUNDLE DI NPM + VENDOR
var bundleUno = require('./bundleUno.js');
// DATI
// var dataValsassinaDB = require('../data/db_valsa_fin.json');

// SCRIPT VERO E PROPRIO
// Generated by CoffeeScript 1.7.1
// 
// Questo è il mio file originario importato dalla folder di ici
(function() {
...
// var mapBoxLayer = L.mapbox.map('map', 'examples.map-zr0njcqy');
  ...
  updatestatovalsa = function() {    
    ...
    if (newstatovalsa !== statovalsa) {
      ...
      statovalsa=newstatovalsa;
      if(statovalsa==="valsa"){
        // questa è da cambiare perchè voglio importare il json semplicemente come js, racchiudendolo dentro una variabile
        // quindi mi basta la parte da layervalsa in poi di fatto..
        // cioè tolgo il $.getJSON
        // perchp ora ho la variabile data che racchiude il JSON 
        // var data = require(‘./path/to/data.json’);
        // e che bundleato con Browserify 
        // insieme agli altri scripts
        
        $.getJSON("db_valsa_fin.json",function (data) {                       
